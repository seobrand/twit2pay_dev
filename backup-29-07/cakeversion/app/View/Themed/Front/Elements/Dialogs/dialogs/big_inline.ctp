...
<?php 
	...
	*/
	...
	if(isset($dtype)){
		switch($dtype){
			...
			default:$className = 'dialog-big-inline'; break;
		}
	}else{
		$className = 'dialog-big-inline'; 
	}
	...
	*/
	...
	if(isset($type)){
		switch($type){
			case 'info': $className2 = 'info'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is an information message';
			break;
			case 'msg':$className2 = 'msg'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is a message';
			break;
			case 'success':$className2 = 'success'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is a success message';
			break;
			case 'warning':$className2 = 'warning'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is a warning message';
			break;
			case 'error':$className2 = 'error'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is an error message';
			break;
			default:$className2 = 'info'; 
							$message_head_inner = isset($message_head) ? $message_head: 'This is a message';
			break;
		}
	}else{
...
<div class="<?php echo $className . ' ' . $className2; ?>">
  <h3><?php echo $message_head_inner; ?></h3>
  <span>x</span>
