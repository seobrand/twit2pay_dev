                                 ...
                                 <div class="powerwidget" id="widget1">
                                    ...
                                    <div> 
                                        <div class="inner-spacer">  
                                       	...
                                       	<?php echo $this->Form->create('User', array('action' => 'addUser', 'enctype' => 'multipart/form-data','id'=>'form-validation')); ?>
										<?php   if (count($userGroups) >2) { ?>
                                           <?php echo $this->Session->flash(); ?>
                                                <fieldset>
                                                <legend contenteditable="true">Here you can add new user.</legend>
                                       ...
                                       <?php echo $this->Form->input("user_group_id" ,array('type' => 'select', 'label' => false,'div' => false,'id'=>'af-present','data-validation-type'=>'present' ))?>                 
                                                    ...
                                                    <div class="g_1_4">
                                                        <label for="af-present">Username:</label> 
                                                    </div>
                                                    <div class="g_3_4_last">
                                       <?php echo $this->Form->input("username" ,array('label' => false,'div' => false,'id'=>'af-present','data-validation-type'=>'present' ))?>
