...
<aside> 
  ...
  <div id="sidebar-profile">
    ...
    <div id="profile-info">
      <div> <a href="<?php echo $this->Html->url("/admin/myprofile", true); ?>"><b>Administrator</b></a> <a href="<?php echo $this->Html->url("/admin/editUser/".$this->UserAuth->getUserId(), true); ?>">Profile settings</a> <a href="javascript:void(0);">Server settings</a> <a href=<?php echo $this->Html->url("/admin/logout", true); ?>>Logout</a> </div>
    </div>
  </div>
