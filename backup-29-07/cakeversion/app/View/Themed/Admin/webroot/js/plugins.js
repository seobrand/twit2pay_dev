...
$(document).ready(function($){
	...
	**/	
	...
	/*$('#form-validation').eContactForm({
		...
		labelSuccess: 'Your message has been send successfully! ads fdas fds',
...
*/
	...
	**/	
	...
	$('a#open-loader-1').click(function(e){
		$.e_notify.loader({
			 image: WEBROOT+'img/loaders/type2/light/32.gif',
			 position: 'center',
			 imageSize: '32 | 32',
			 delay: 0,
			 time: 1200,
	...
	$('a#open-loader-2').click(function(e){
		$.e_notify.loader({
			 image: WEBROOT+'img/loaders/type4/light/56.gif',
			 position: 'right-bottom',
			 imageSize: '56 | 19',
			 delay: 0,
			 time: 2000,
	...
	$('a#open-notification-3').click(function(e){
		 $.e_notify.notification({
			 text: '<img src="'+WEBROOT+'img/icons/dialogs/plus-16.png" alt=""/> Yes you can add a notification to a target!',
			 position: 'top',
			 target: '#widget2 > div',
			 delay: 0,
			 time: 2500,
	...
	**/	
    ...
    if($('#wysiwyg').length){
		$('#wysiwyg').elrte({
			...
			toolbar  : 'complete',
			height   : 250
			//cssfiles: WEBROOT+'css/theme/darkblue.css'		
		});
	}
	...
	**/	
	if($('#wysihtml5-textarea').length){
		var editor = new wysihtml5.Editor("wysihtml5-textarea", {
			toolbar:      "toolbar",
			stylesheets:  WEBROOT+"css/wysiwyghtml5.css",
	...
	**/	
	...
	$("#datepicker-icon").datepicker({
		showOn: "button",
		buttonImage: WEBROOT+"img/datepicker.png",
