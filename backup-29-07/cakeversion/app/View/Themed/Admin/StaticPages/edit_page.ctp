...
<section class="g_1">
  <div class="powerwidget" id="widget1">
    ...
    <div>
      <div class="inner-spacer"> <?php echo $this->Form->create('StaticPage', array('action' => 'editPage','enctype' => 'multipart/form-data','id'=>'form-validation')); ?>
        <?php //echo $this->Session->flash(); ?>
        <fieldset>
        <legend contenteditable="true">Edit Page.</legend>
        ...
        <div class="g_3_4_last">
          <?php 
		   echo $this->Form->input('StaticPage.id',array('class'=>'button-text','type'=>'hidden'));
