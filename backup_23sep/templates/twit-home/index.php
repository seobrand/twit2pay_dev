...
$doc->addScript($template_js_base_url.'jquery.js', 'text/javascript');
...
$doc->addScript($template_js_base_url.'css3-mediaqueries.js', 'text/javascript');
...
<header>
  <div class="wrapper">
    ...
    <!--   <ul>
        ...
        <li><a href="login.html"><span class="lock_icon"></span>login</a></li>
      </ul> -->
    </nav>
  </div>
</header>
...
<section class="slideshow_container">
  <div class="slideshow">
    ...
    <ul id="slides">
      <li><img src="<?php echo $template_image_base_url  ?>slide4.jpg" alt="slide 1" title="" width="1280" height="553" /></li>
      <li><img src="<?php echo $template_image_base_url  ?>slide1.jpg" alt="slide 3" title="" width="1280" height="553" /></li>
      <li><img src="<?php echo $template_image_base_url  ?>slide2.jpg" alt="slide 2" title="" width="1280" height="553" /></li>
      <li><img src="<?php echo $template_image_base_url  ?>slide5.jpg" alt="slide 4" title="" width="1280" height="553" /></li>
      <li><img src="<?php echo $template_image_base_url  ?>slide3.jpg" alt="slide 4" title="" width="1280" height="553" /></li>
    </ul>
  </div>
</section>
<!--end slideshow-->
...
<section class="middle">
  ...
  <?php if($user->guest){?>
    ...
    <div class="sign_up_container" id="first">
      ...
      Connect with twitter and get started today!
 ...
 <?php }?>
    <div class="content">
      <div class="process_container">
        <ul>
          <li>
            <div class="startup_process_title">START UP</div>
            <div class="process_title_content">Enjoy our straightforward pricing and quick sign up process. Mojo Pay provides you with everything you need to start accepting credit card payments in your online store. </div>
          </li>
          <li>
            <div class="integrate_process_title">INTEGRATE</div>
            <div class="process_title_content">Effortlessly integrate Mojo Pay into your site. We provide you with a secure and reliable payment solution for your online store. </div>
          </li>
          <li>
            <div class="sell_process_title">SELL</div>
            <div class="process_title_content">Make it easy for your customers to pay for your products using MasterCard, Visa, American Express, and Discover. Deposits are made within two days. </div>
          </li>
        </ul>
      </div>
    </div>
