...
<input type="hidden" name="jform[email1]" id="jform_email1" value="<?php echo $ses_var[0]->email; ?>" size="30"/>
<input type="hidden" name="jform[email2]" id="jform_email2" value="<?php echo $ses_var[0]->email; ?>" size="30"/>
<input type="hidden" name="jform[profile][fname]" id="jform_profile_fname" value="<?php echo $profile->profile['fname']; ?>"/>
<input type="hidden" name="jform[profile][lname]" id="jform_profile_lname" value="<?php echo $profile->profile['lname']; ?>"/>
<input type="hidden" name="jform[profile][phone]" id="jform_profile_phone" value="<?php echo $profile->profile['phone']; ?>"/>
<input type="hidden" name="jform[profile][dob]" id="jform_profile_dob" value="<?php echo $profile->profile['dob']; ?>"/>
<input type="hidden" name="jform[profile][gender]" id="jform_profile_gender" value="<?php echo $profile->profile['gender']; ?>"/>
...
<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save2'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
 <div class="step_third">
      ...
      <ul class="step_listing">
       <li>
      <input id="jform_profile_name_on_card" type="text" class="step_input required" aria-required="true" required="required"  maxlength="40" size="30" value="<?php if($ses_var[0]->cc_name != ''){ echo $ses_var[0]->cc_name;}else{echo $ses_var[0]->name;} ?>" onfocus="if(this.value=='Name on Card :'){this.value=''}" onblur="if(this.value=='') {this.value='Name on Card :'}" name="jform[profile][name_on_card]" >
      </li>
      </ul>
