  ...
  <div class="update_form_main">
		...
		<select id="jform_profile_expyear" class="update_sel" name="jform[profile][expyear]" aria-invalid="false">
          ...
          <li class="clearfix">
            ...
            <div class="update_right_box">
              <input type="text" id="jform_profile_baddress" name="jform[profile][baddress]" <?php if($same_as_ship == 'yes'){?> disabled="disabled"<?php }?> value="<?php echo $profile->profile['baddress']?>" aria-required="true" required="required" class="update_input">
            </div>
          </li>
          <li class="clearfix">
            <div class="update_left_text">City</div>
            <div class="update_right_box">
              <input type="text" id="jform_profile_bcity" name="jform[profile][bcity]" <?php if($same_as_ship == 'yes'){?> disabled="disabled"<?php }?> value="<?php echo $profile->profile['bcity']?>" aria-required="true" required="required" class="update_input">
            </div>
          </li>
          <li class="clearfix">
            <div class="update_left_text">State</div>
            <div class="update_right_box">
              <select id="jform_profile_bregion" name="jform[profile][bregion]" <?php if($same_as_ship == 'yes'){?> disabled="disabled"<?php }?> class="update_sel" aria-invalid="false">
          ...
          <li class="clearfix">
            ...
            <div class="update_right_box">
             <ul class="user_action">
                <li>
                <input type="text" id="jform_profile_bpostal_code" name="jform[profile][bpostal_code]" <?php if($same_as_ship == 'yes'){?> disabled="disabled"<?php }?> value="<?php echo $profile->profile['bpostal_code']?>" aria-required="true" required="required" class="update_input_03"></li>
